...
# -----------------------------------------------------
# ૧. પેજ સેટિંગ (UPDATED: Title changed to Gyan Live for sharing metadata)
# -----------------------------------------------------
        ...
        with st.spinner("Working on it"):
            try:
                if category == "સંપૂર્ણ પેપર (૧૦૦ ગુણ)":
                    ...
                    ૫. વ્યાકરણ (૨૦ પ્રશ્નો, ૨૦ ગુણ): ૧0 અલગ-અલગ ટોપિક છે (રૂઢિપ્રયોગ, કહેવતો, સમાસ, છંદ, અલંકાર, શબ્દસમૂહ, જોડણી, લેખનશુદ્ધિ, સંધિ, વાક્ય રચના). દરેક ટોપિકમાંથી ફરજિયાત ૨ પ્રશ્નો પૂછાયા હશે. દરેક સાચા જવાબનો ૧ ગુણ, સહેજ પણ ભૂલ હોય તો સીધો ૦ ગુણ.
                    """
